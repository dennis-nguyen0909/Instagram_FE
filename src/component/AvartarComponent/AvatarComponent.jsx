...
export const AvatarComponent = ({ name, email, image, onClick, id, style }) => {
    return (
        <div className='story' style={{ backgroundColor: 'rgb(255,255,255,0.75)', padding: '1px', display: 'flex', cursor: 'pointer', ...style }} onClick={onClick}>
